...
fetch('https://625f14aa873d6798e2b29ded.mockapi.io/:endpoint').then((response)=>response.json()
).then(_indexJsDefault.default);

},{"./index.js":"jvaAX","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"jvaAX":[function(require,module,exports) {
...
.then((response)=>{
    const images = response.map((obj)=>obj.download.url
    );
    for (const url of images){
        const image = document.createElement(`img`);
        image.src = url;
...
},{}]},["l4FI8","l1HD1"], "l1HD1", "parcelRequiread0c")
